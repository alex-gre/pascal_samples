...
uses
  ...
  SynHighlighterCpp, SynHighlighterPas, SynHighlighterSQL, SynHighlighterPython,
  Forms, Controls, Graphics, Dialogs, Menus, Windows;
...
begin
    WinExec('hh.exe help_OS.chm',SW_SHOW);
end;

procedure TForm1.MenuItem34Click(Sender: TObject);
begin
   WinExec('Systman.exe',SW_SHOW);
end;

procedure TForm1.MenuItem35Click(Sender: TObject);
begin
      WinExec('hh.exe help_tcp.chm',SW_SHOW);
end;
